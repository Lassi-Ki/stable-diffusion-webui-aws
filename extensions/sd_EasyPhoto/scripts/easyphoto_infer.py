    ...
    for template_idx, template_image in enumerate(template_images):
        ...
        try:
            ...
            if total_processed_person != 0:
                ...
                if super_resolution:
                    try:
                        ...
                        torch.cuda.empty_cache()
                        traceback.print_exc()
                        print(f"Portrait enhancement error: {e}")
            ...
            if shared.upload_image(output_img_path, user_id, user_ids[0]):
                ...
                print(f"Template {str(template_idx + 1)} Failed.")
    ...
    *user_ids,
    ...
    if tabs == 0:
        ...
        if upload_control_video:
            ...
            ep_logger.info(f"Using {upload_control_video_type} control for video control input")
            controlnet_pairs = [[upload_control_video_type, template_images[0], 1, 1]]
